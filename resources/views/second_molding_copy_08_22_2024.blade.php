                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="collapse" id="collapseAddShotsSamples">
                                                <div class="input-group input-group-sm mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm sumTotalMachineOutput" id="target_shots" name="target_shots" value="25">
                                                </div>
                ...
                */
                ...
                $('#textProductionLotTime').keyup(delay(function(e){
                    ...
                    if(textProductionLotTime.length >= 11){
                        let custom_substr = 6 + parseInt(noOfPages);
                        //This data depends on RAPID ACDCS: Revision & Pages
                        //INPUT: Revision number based on Number of Pages eg. 2 pages Revision M
                        //OUTPUT: subTextProductionLot = MM
                        //TODO: Prodn lotnumber will automatically get the RAPID ACDCS rather than RAPID DIESET
                        let subTextProductionLot = textProductionLot.substr(0, custom_substr); //PR2410109522 //PR2410112314
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if(response.length > 0){
                                ...
                                noOfPages =  response[0].no_of_pages
                                $('#textProductionLotTime').removeAttr('readonly',true);
                            ...
                            case 'formMELotNumberOne':
                                if(qrScannerValue != ''){
                                    ...
                                    */
                                    ...
                                    //     $('#modalMaterialDrying').modal('show');
                                    // }
                                }else{
