            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form method="post" id="formMimf" autocomplete="off">
                        ...
                        <input type="text" class="col-1 input_hidden" id="txtMimfStampingMatrixStatus" name="mimf_stamping_matrix_status" placeholder="Status"required>
                        ...
                        <div class="modal-body">
                            <div class="row"><!-- Start Row MIMF Data -->
                                ...
                                <div class="col-6 mt-3">
                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input update-mimf-pps_request" type="radio" name="update_mimf_and_pps_request" id="radioBtnUpdateMimf" value="1" required disabled>
                                        <label class="form-check-label" for="inlineRadio1">Update MIMF</label>
                                    </div>
                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input update-mimf-pps_request" type="radio" name="update_mimf_and_pps_request" id="radioBtnPpsRequest" value="2" required readonly>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#buttonAddMimf').click(function(event){
                    ...
                    $('#txtMimfStampingMatrixStatus').val($('#selectCategory').val())
                ...
                $("#txtMimfPmiPoNo").keyup(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response){
                            if($('#txtMimfStampingMatrixStatus').val() == 2){
                                ...
                                if(getPoReceivedPmiPoForMolding.length > 0){
                                    ...
                                    if(getPoReceivedPmiPoForMolding[0].pps_dieset_info != null){
                                        ...
                                        kgsMolding = (poQuantity*diesetShotWeight/1000/diesetNoOfCavity).toFixed(2)
                                        if(kgsMolding != 'NaN'){
                ...
                $('.uncheck').change(function (e) { 
                    e.preventDefault();
                    if( $('#radioBtnSecondCategory').is(':checked') && $('#txtMimfStampingMatrixStatus').val() == 1){
