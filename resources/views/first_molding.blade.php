...
@section('content_page')
                        ...
                        <div class="card card-dark">
                            ...
                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select form-control" id="global_device_name"
                                                    ...
                                                    <div class="col-sm-2 d-none">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="global_input_device_name" name="global_input_device_name"
                                                            readonly>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <label>Contact Name</label>
                                                        <input type="text" class="form-control" id="global_contact_name"
                                                            name="global_contact_name" readonly>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <label>PO Number</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="global_po_no"
                                                                name="global_po_no" list="datalist_mimf_po_num">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label>PO Qty</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="global_po_qty"
                                                                name="global_po_qty" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                id="global_target_qty" name="global_target_qty" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="tblFirstMoldingDetails"
                        ...
                        <div class="row">
                            <div class="col-sm-6 border px-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="radioIQC"
                                        value="0" disabled>
                                    <label class="form-check-label" for="radioIQC">For Quali</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="radioMassProd"
                                        value="1" disabled>
                                    <label class="form-check-label" for="radioMassProd">For Mass Production</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="radioResetup"
                                        value="2" disabled>
                                ...
                                <div class="input-group input-group-sm mb-3 d-none">
                                    ...
                                    <input class="form-control form-control-sm" type="text" id="first_molding_id"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <select class="form-select form-control-sm" id="first_molding_device_id"
                                                name="first_molding_device_id">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <span class="input-group-text w-100" id="basic-addon1">Contact Name:
                                                </span>
                                            </div>
                                            <input value="25" type="text" class="form-control form-control-sm"
                                                id="contact_name" name="contact_name" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <span class="input-group-text w-100" id="basic-addon1">Contact Lot
                                                    #</span>
                                            </div>
                                            <div class="input-group-prepend">
                                                <button type="button" class="btn btn-dark" id="btnScanQrFirstMolding"><i
                                                        class="fa fa-qrcode w-100"></i></button>
                                            </div>
                                            <input type="text" class="form-control form-control-sm"
                                                id="contact_lot_number" name="contact_lot_number" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                id="contact_lot_qty" name="contact_lot_qty" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="dieset_no"
                                                name="dieset_no">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <select type="text" class="form-control form-control-sm" id="machine_no"
                                                name="machine_no" placeholder="Machine #" sytle="width:100%">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="shift"
                                                name="shift" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <span class="input-group-text w-100" id="basic-addon1">Adjustment
                                                    Shots</span>
                                            </div>
                                            <input type="number"
                                                class="form-control form-control-sm sumTotalMachineOutput"
                                                id="adjustment_shots" name="adjustment_shots" min="0"
                                                step="0.01">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="number"
                                                class="form-control form-control-sm sumTotalMachineOutput" id="ng_count"
                                                name="ng_count" min="0" step="0.01" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <span class="input-group-text w-100" id="basic-addon1">Total Machine
                                                    Output</span>
                                            </div>
                                            <input type="number" class="form-control form-control-sm"
                                                id="total_machine_output" name="total_machine_output" min="0"
                                                step="0.01" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <span class="input-group-text w-100" id="basic-addon1">Shipment
                                                    Output:</span>
                                            </div>
                                            <input type="number"
                                                class="form-control form-control-sm sumTotalMachineOutput"
                                                id="shipment_output" name="shipment_output" min="0"
                                                step="0.01" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                id="material_yield" name="material_yield"
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <span class="input-group-text w-100" id="basic-addon1">PMI PO
                                                    Number</span>
                                            </div>
                                            <input value="PR2310089320" type="text"
                                                class="form-control form-control-sm" id="pmi_po_no" name="pmi_po_no"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="number" class="form-control form-control-sm"
                                                id="required_output" name="required_output" min="0"
                                                step="0.01" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="number" class="form-control form-control-sm" id="po_qty"
                                                name="po_qty" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 d-none">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <span class="input-group-text w-100" id="basic-addon1">Target For
                                                    S/O</span>
                                            </div>
                                            <input type="number" class="form-control form-control-sm" id="po_target"
                                    ...
                                    <div class="col-sm-6  d-none">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="number" class="form-control form-control-sm" id="po_balance"
                                                name="po_balance" min="0" step="0.01" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="created_at"
                                                name="created_at" readonly="true" placeholder="Auto generated">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-none">
                                                            <div class="input-group input-group-sm mb-3">
                                                                <div class="input-group-prepend">
                                                                    <button type="button" class="btn btn-dark"
                                                                        id="btnScanQrFirstMolding"><i
                                                                            class="fa fa-qrcode w-100"></i></button>
                                                                </div>
                                                                <input type="text" class="form-control form-control-sm"
                                                                    id="recycle_material" name="recycle_material[]">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="input-group input-group-sm mb-3">
                    ...
                    <div class="py-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm small table-bordered table-hover"
                                id="tblFirstMoldingStationDetails" style="width: 100%;">
                                <thead>
                                    <tr class="bg-light">
                                        <th></th>
                                        <!-- <th></th> -->
    ...
    <div class="modal-footer justify-content-between">
        ...
        <button type="button" id="btnSubmitFirstMoldingStation" class="btn btn-primary" disabled><i
                    ...
                    <form id="formFirstMoldingStation">
                        ...
                        <div class="row d-none">
                            <div class="col">
                                <div class="input-group input-group-sm mb-3">
                                    <div class="input-group-prepend w-50">
                                        <span class="input-group-text w-100" id="basic-addon1">First Molding Detail
                                            Id</span>
                                    </div>
                                    <input type="text" class="form-control form-control-sm"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <select type="text" class="form-control form-control-sm" id="station"
                        ...
                        <div class="row d-none" id="isSelectCameraInspection">
                            <div class="col">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <select type="text" class="form-control form-control-sm" id="size_category"
                                        name="size_category" placeholder="Station">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="input"
                                        name="input" min="0" step="0.01" readonly>
                                    <div class="input-group-text">
                                        <input type="checkbox" value="1" id="is_partial" name="is_partial">
                                    </div>
                                    <input type="text" class="form-control form-control-sm" placeholder="Partial?"
                                        id="input" name="input" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="ng_qty"
                                        name="ng_qty" min="0" value="0" step="0.01">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="output"
                                        name="output" min="0" step="0.01" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="station_yield"
                                        name="station_yield" step="0.01"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="table-responsive">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <label>Total No. of NG: <span id="labelTotalNumberOfNG"
                                                style="color: red;">0</span>
                                            <label>
                                                &nbsp;<li class="fa-solid fa-thumbs-down" id="labelIsTally"
                                                    style="color: red;"></li>
                                            </label>
                                        </label>
                                        <button type="button" id="buttonAddFirstMoldingModeOfDefect"
                                            class="btn btn-sm btn-info" title="Add MOD" disabled><i
                                                class="fa fa-plus"></i> Add MOD</button>
                                    </div>
                                    <br>
    ...
    <div class="modal fade" id="mdlScanQrCodeFirstMolding" data-formid="" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    {{-- hidden_scanner_input --}}
                    <input type="text" class="scanner w-100 hidden_scanner_input" id="txtScanQrCodeFirstMolding"
                        name="scan_qr_code" autocomplete="off">
                    <div class="text-center text-secondary">Please scan the code.<br><br>
    ...
    <div class="modal fade" id="mdlScanQrCodeFirstMoldingMaterial" data-formid="" tabindex="-1" role="dialog"
        aria-labelledby="ModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-0 pb-0">
                ...
                <div class="modal-body pt-0">
                    ...
                    <input type="text" class="scanner w-100 hidden_scanner_input" id="txtScanQrCodeFirstMolding"
                        name="scan_qr_code" autocomplete="off">
                    <div class="text-center text-secondary">Please scan the Material QR code.<br><br>
                        <h1><i class="fa fa-qrcode fa-lg"></i></h1>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="modalMaterialLotNum" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-top" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-2">
                    {{-- hidden_scanner_input --}}
                    <input type="text" class="w-100 hidden_scanner_input" id="txtLotNum" autocomplete="off"
                        is_inspected="false">
                    ...
                    <div class="text-center text-secondary">Please scan Lot Number.<br><br>
                        <h1><i class="fa fa-qrcode fa-lg"></i></h1>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <!-- PO 1 -->
                        <div class="col-sm-12">
                            <center><img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(150)->errorCorrection('H')->generate('0')) !!}" id="img_barcode_PO"
                                    style="max-width: 200px;"><br></center>
                            <label id="img_barcode_PO_text"></label>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" id="btnFirstMoldingPrintQrCode" class="btn btn-primary btn-sm"><i
                            class="fa fa-print fa-xs"></i> Print</button>
        ...
        $(document).ready(function() {
            ...
            table.FirstMoldingStationDetails.on('click', '#btnPrintFirstMoldingStation', function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        "first_molding_detail_id": firstMoldingStationId
                    },
                    dataType: "json",
                    success: function(response) {
                        console.log(response);
            ...
            $('#btnFirstMoldingStation').click(function(e) {
                ...
                formModal.firstMoldingStation.find('#buttonAddFirstMoldingModeOfDefect').prop('disabled',
                    true);
                formModal.firstMoldingStation.find('#first_molding_id').val(formModal.firstMolding.find(
                    '#first_molding_id').val());
                formModal.firstMoldingStation.find('[type="number"]').val(0)
                formModal.firstMoldingStation.find('#station_yield').val('0%');
            ...
            */
            ...
            $("#buttonAddFirstMoldingModeOfDefect").click(function() {
                ...
                getModeOfDefectForFirstMolding($("#tableFirstMoldingStationMOD tr:last").find(
                    '.selectMOD'));
            ...
            $('#global_device_name').change(function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        "first_molding_device_id": $(this).val()
                    },
                    dataType: "json",
                    success: function(response) {
                        ...
                        formModal.firstMolding.find('#first_molding_device_id').html(
                            `<option value="${first_molding_device_id}">${device_name}</option>`
                        );
            ...
            $('#txtScanQrCodeFirstMolding').on('keyup', function(e) {
                ...
                try {
                    ...
                    // console.log(error);
                    toastr.error(
                        `${scanFirstMoldingContactLotNo} Invalid Prodn Lot Number. Please Check to 2nd Stamping Module !`
                    )
            ...
            formModal.firstMoldingStation.find('#ng_qty').keyup(function(e) {
                ...
                totalStationYield(formModal.firstMoldingStation.find("#input").val(), formModal
                    .firstMoldingStation.find("#output").val());
